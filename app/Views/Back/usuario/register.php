<section class="principal d-flex flex-column justify-content-between">
    ...
    <section class=" p-2 py-5 d-flex justify-content-center align-items-center">
        ...
        <form class="row g-3 ancho-form px-2 rounded-5 fondo-img text-warning" method="post" action="<?= base_url('registro') ?>" autocomplete="off">
            ...
            <div class="col-12 d-flex justify-content-center">
                <button type="submit" name="registrar" class="btn btn-warning text-light mx-1">Aceptar</button>
                <button type="reset" class="btn btn-warning text-light mx-1">Cancelar</button>
            </div>
            <div class="col-md-12">
                <p>¿Ya tienes una cuenta? <a href="section_iniciar_sesion">Ingresar aquí</a></p>
            </div>
        </form>
